---
title:  "So you want to work on a new pathogen"
date:   2026-02-15 10:00:10 -0400
categories: bioinformatics pathogens
---

I feel like this is a trend that goes unnoticed.
Imagine, you are a bioinformatician but you go into a new lab or go into a new project.
You know your basics: genome assembly all the way through genome annotation.
You know how to compare genomes with SNPs and MLST everything in between.

You might have been trained on _E. coli_. Or maybe you were trained on _Neisseria meningitidis_.
Whatever the case, now you have to learn about a new organism in your new project, _Cryptococcus razy_.
...
Know these basic genomic characteristics.

## Genes of interest

You are studying this new pathogenic organism for a reason.
It has some horrible toxin or a nasty phage in it.
What is that toxin? Is it a single gene?
Does it always get delivered on a phage?
Can it be turned on and off? Maybe through slipped strand mispairing?

Is it also interesting because it turns blue?
It has haemolytic activity?
There are genetic determinants for these things and so you can get familiar with them.

## Taxonomy

Your pathogen doesn't live in a vacuum.
What is _C. razy_ related to?
It's in the genus _Cryptococcus_ and so there's a start.
Zoom out one more step. What family is it in?
Zoom out all the way. What Domain are you in? Bacteria?
There was one project that I had in grad school where I thought I was working on bacteria the whole time but it was in fact not.
It was the nematode (Eukaryote), _Caenorhabditis elegans_.
...
Just knowing these basic things will help you get started on your project.
It will give you the right vocabulary to talk with your peers in the lab and between labs.
